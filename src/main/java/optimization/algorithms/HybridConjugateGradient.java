...
public class HybridConjugateGradient extends Algorithm{
    double h0;
    double epsilon;
    double beta;
    int maxIterations;
    ...
    public HybridConjugateGradient(double h0, double epsilon, int maxIterations) {
        this.h0 = h0;
    ...
    public String toString(){
        return "Hybrid-Conjugate-Gradient";
    }
}